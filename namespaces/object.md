...
| `GetYaw` | `nYaw = Object.GetYaw(uGuid)` | Used with a plain `uGuid` argument in real game scripts, returns a single yaw value. |
| `SetYaw` | `Object.SetYaw(uGuid, nYaw)` | Used with `uGuid` and a numeric yaw in real game scripts. |
