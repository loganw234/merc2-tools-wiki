...
| `SpawnHomingProjectile` | `Junk.SpawnHomingProjectile(...)` | No call sites found in the decompiled corpus — exists (confirmed via live `pairs()` enumeration) but usage/arguments unconfirmed. |
