...
live-tested.** One known data-quality gotcha: the export's `is_vehicle` flag is unreliable for
...
| [Weapons](weapons) | 165 | Weapon-type templates — the player arsenal, given via `SetAllWeapons` |
